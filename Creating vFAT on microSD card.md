...
![gparted search](partition_gparted_install.png "Install gparted on Ubuntu")
...
![gparted USB](partition_gparted_select_USB.png "Transfer USB to VM")
...
![gparted Select USB](partition_gparted_select_drive.png "Select USB Drive")
...
![gparted resize](partition_gparted_unmount_1.png "Resize Partition")
...
![gparted resize](partition_gparted_resize_2.png "Resize Partition")

In the box that shows up, click in the second box down and change the existing number to 4000.

![gparted resize](partition_gparted_resize_3.png "Resize Partition")
...
![gparted resize](partition_gparted_resize_4.png "Resize Partition")

A warning screen will come up...just click the "OK" button

![gparted resize](partition_gparted_resize_5.png "Resize Partition")

On the top menu, first click the green checkmark icon.  Another warning will come up.  Click on the "Apply" button.

![gparted resize](partition_gparted_resize_6.png "Resize Partition")
...
![gparted resize](partition_gparted_resize_7.png "Resize Partition")
...
![gparted resize](partition_gparted_resize_8.png "Resize Partition")
...
![gparted resize](partition_gparted_resize_9.png "Resize Partition")

Once again, a warning message will come up. Click on the "Apply" button to continue.

![gparted resize](partition_gparted_resize_10.png "Resize Partition")

This will take a relatively short bit of time to complete.

![gparted resize](partition_gparted_resize_11.png "Resize Partition")

Once the process has finished successfully, you'll get a screen like this:

![gparted resize](partition_gparted_resize_12.png "Resize Partition")
...
![Terminal](partition_gparted_terminal.png "Terminal")
...
![Terminal](partition_gparted_terminal_2.png "Terminal")
...
![Terminal](partition_gparted_terminal_3.png "Terminal")
...
![Terminal](partition_windows_error.png "Terminal")
