...
[http://fontawesome.io/icons/](http://fontawesome.io/icons/)
    ...
    Give your folder the same name as the icon you want to show. For example,if you want to use the [address book icon], your folder should be
    named `address-book`. Your ConnectBox will automatically use that icon
    when it displays that folder to the user.
